...
!function(global, factory) {
    ...
    stroke(strokeColor){
        this.attributes.stroke = strokeColor;
        return this;
    },
    css(){
        ...
        this.attributes.style = css.toString();
        return this;        
    }
}
        ...
        if (!component._disable) {
            ...
            if (!component.base || mountAll) {
                ...
                if(component.getDefaultProps) {
                    props = utils.extend(true,component.getDefaultProps(),props);
                }
    ...
    function buildComponentFromVNode(dom, vnode, context, mountAll) {
        ...
        if (c && isOwner && (!mountAll || c._component)) {
            ...
            setComponentProps(c, c.props, 1, context, mountAll);
            dom = c.base;
    ...
    function Component(props, context) {
        ...
        if(defaultProps) {
            props = utils.extend(true,defaultProps,props);
        }
        this.props = props;
