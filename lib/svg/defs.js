...
//滤镜
cad.registDefs("blur",function(option){
var paper = this;
...
cad.registDefs("shadow",function(option){
	var paper = this;
	var $defs = paper.select("defs");
...
cad.registDefs("linearGradient",function(option){
	var paper = this;
	var $defs = paper.select("defs");
	option = cad.extend(true,
			{
...
cad.registDefs("radialGradient",function(option){
	var paper = this;
	var $defs = paper.select("defs");
	option = cad.extend(true,
			{
...
cad.registDefs("gray",function(id){
	var paper = this;
	id = id || "gray";
	var $defs = paper.select("defs");
	var filter = paper.createSVGElement("filter").attr("id",id);
